...
export default function NewSpotPage() {
  ...
  const updateMenu = (id: string, field: keyof MenuFormData, value: any) => {
  ...
  const handleMenuImageChange = (id: string, file: File | null) => {
    if (file) {
      const reader = new FileReader();
      reader.onloadend = () => {
        updateMenu(id, 'imagePreview', reader.result as string);
        updateMenu(id, 'image', file);
      };
      reader.readAsDataURL(file);
    } else {
      updateMenu(id, 'imagePreview', null);
      updateMenu(id, 'image', null);
    }
  };
    ...
    <Box>
      <Box sx={{ mb: 4 }}>
        <Breadcrumbs sx={{ mb: 1 }}>
          ...
          <Typography color="text.primary" sx={{ fontSize: '0.875rem' }}>新規登録</Typography>
        </Breadcrumbs>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Stack spacing={4}>
              ...
              <Paper elevation={0} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 3 }}>
                ...
                {menus.length === 0 ? (
                  <Box sx={{ py: 4, textAlign: 'center', border: '1px dashed #e2e8f0', borderRadius: 2, bgcolor: '#fcfcfc' }}>
                          ...
                          <Grid size={{ xs: 12, sm: 9 }}>
                            <Stack spacing={2}>
                              ...
                              <TextField
                                ...
                                rows={2}
                                value={menu.detail}
                                onChange={(e) => updateMenu(menu.id, 'detail', e.target.value)}
                              />
                              <FormControlLabel
                                control={
                                  <Switch 
                                    ...
                                    onChange={(e) => updateMenu(menu.id, 'isRecommend', e.target.checked)}
                                  />
                                }
                                label={
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Stack spacing={4}>
              ...
              <Paper elevation={0} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 3 }}>
                ...
                <Stack spacing={3}>
                  <TextField fullWidth label="営業時間" name="business_hours" variant="outlined" multiline rows={2} />
                  <TextField fullWidth label="定休日" name="closed_days" variant="outlined" />
                  <TextField fullWidth label="滞在時間目安" name="stay_duration" variant="outlined" />
                </Stack>
              </Paper>
              ...
              <Paper elevation={0} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 3 }}>
                ...
                <Stack spacing={3}>
                  <TextField fullWidth label="電話番号" name="phone_number" variant="outlined" />
                  <TextField fullWidth label="平均予算" name="average_budget" variant="outlined" InputProps={{ startAdornment: <InputAdornment position="start">¥</InputAdornment> }} />
                  <TextField fullWidth label="公式サイト URL" name="website_url" type="url" variant="outlined" />
                </Stack>
              </Paper>
